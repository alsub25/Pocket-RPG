...
const ENEMY_TEMPLATES = {
    ...
    // --- Crimson Canopy (Chapter V expansion) -------------------------------
    canopyGuardian: {
        id: 'canopyGuardian',
        ...
        isBoss: false,
        behavior: 'cunning',
        affinities: { weak: { fire: 1.3 }, resist: { arcane: 0.8 } }
    },
    thornweaver: {
        id: 'thornweaver',
        name: 'Thornweaver Mystic',
        baseLevel: 29,
        maxHp: 440,
        attack: 32,
        magic: 64,
    ...
    crimsonStalker: {
        ...
        isBoss: false,
        behavior: 'aggressive',
        affinities: { weak: { frost: 1.2 } }
    },
    skysentinel: {
        id: 'skysentinel',
        name: 'Skybound Sentinel',
        baseLevel: 31,
        maxHp: 500,
        attack: 66,
        magic: 38,
    ...
    // --- Thornheart Grotto (Chapter V expansion) ----------------------------
    blightspawn: {
        id: 'blightspawn',
        name: 'Blightspawn',
        baseLevel: 32,
        ...
        isBoss: false,
        behavior: 'caster',
        affinities: { weak: { arcane: 1.25 }, resist: { fire: 0.85, frost: 0.85 } }
    },
    thornhulk: {
        id: 'thornhulk',
        name: 'Thornheart Hulk',
        baseLevel: 33,
        maxHp: 720,
        attack: 88,
        magic: 0,
    ...
    // --- Whisperwind Plateau (Chapter V expansion) --------------------------
    stormcaller: {
        id: 'stormcaller',
    ...
    windwraith: {
        ...
        isBoss: false,
        behavior: 'cunning',
        affinities: { weak: { arcane: 1.2 }, resist: { physical: 0.75 } }
    },
    skyterror: {
        id: 'skyterror',
        name: 'Sky Terror',
    ...
    // --- Emberfall Sanctum (Chapter V expansion - final zone) ---------------
    emberfallen: {
        id: 'emberfallen',
        name: 'Emberfallen Knight',
        baseLevel: 41,
        maxHp: 920,
        attack: 116,
        magic: 72,
...
const ZONE_DEFS = {
    ...
    crimsonCanopy: { id: 'crimsonCanopy', minLevel: 28, maxLevel: 32 },
    thornheartGrotto: { id: 'thornheartGrotto', minLevel: 32, maxLevel: 36 },
    whisperwindPlateau: { id: 'whisperwindPlateau', minLevel: 36, maxLevel: 40 },
    emberfallSanctum: { id: 'emberfallSanctum', minLevel: 40, maxLevel: 45 }
}
...
const RANDOM_ENCOUNTERS = {
    ...
    crimsonCanopy: ['canopyGuardian', 'thornweaver', 'crimsonStalker', 'skysentinel'],
    thornheartGrotto: ['blightspawn', 'thornhulk', 'corruptedDryad', 'venomspitter'],
    whisperwindPlateau: ['stormcaller', 'windwraith', 'skyterror', 'ancientHarpy'],
    emberfallSanctum: ['emberfallen', 'flamewarden', 'ashguard', 'primordialFlame']
}
