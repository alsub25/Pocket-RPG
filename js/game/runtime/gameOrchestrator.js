...
// --- Smoke Tests (extracted to qa/smokeTests.js for size reduction) ----------
let _runSmokeTestsImpl = null
async function runSmokeTests(opts = {}) {
    if (!_runSmokeTestsImpl) {
        // Lazy-load the massive smoke test suite only when needed
        const module = await import('../qa/smokeTestsImpl.js')
        _runSmokeTestsImpl = module.createSmokeTestRunner({
            state,
            setState: _setState,
            GAME_PATCH,
            GAME_PATCH_NAME,
            ...
            updateEnemyPanel: _liveUpdateEnemyPanel,
            buildAbilityContext,
            useAbilityInCombat,
            playerBasicAttack,
            _recalcPlayerStats,
    ...
    return _runSmokeTestsImpl.runSmokeTests(opts)
}
