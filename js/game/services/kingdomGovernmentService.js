...
import {
  initGovernmentState as initGovState,
  handleGovernmentDayTick as handleGovDayTick,
  getGovernmentSummary as getGovSummary,
...
export function createKingdomGovernmentService(engine) {
  if (!engine) throw new Error('KingdomGovernmentService requires engine instance');
