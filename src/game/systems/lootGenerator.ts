...
function buildArmor(level, rarity, area = 'forest', isBoss = false, forcedSlot = null) {
    ...
    if (!forcedSlot && uniqueLegendary && uniqueLegendary.slot) slot = uniqueLegendary.slot
...
export function generateArmorForSlot({
    area = 'forest',
    level = 1,
    rarity = 'common',
    isBoss = false,
...
export function generateLootDrop({
    ...
    forceGearMinRarity = null,
    forceGearRarity = null
} = {}) {
