...
import { ensureQuestStructures, initMainQuest as initMainQuestImpl, getActiveSideQuests, startSideQuest as startSideQuestImpl, advanceSideQuest as advanceSideQuestImpl, completeSideQuest as completeSideQuestImpl, applyQuestProgressOnItemGain as applyItemProgressImpl, applyQuestProgressOnEnemyDefeat as applyEnemyProgressImpl } from '../quests/questSystem.js';
/**
...
export function createQuestSystemService(engine) {
    if (!engine)
        throw new Error('QuestSystemService requires engine instance');
    /**
