...
import { DAY_PARTS, FANTASY_WEEKDAYS, getTimeInfo, formatTimeLong, formatTimeShort } from '../systems/timeSystem.js';
function normalizeTimeObject(time) {
    if (!time || typeof time !== 'object')
        return { dayIndex: 0, partIndex: 0 };
...
export function createTimeService(engine) {
    if (!engine)
        throw new Error('TimeService requires engine instance');
    /**
