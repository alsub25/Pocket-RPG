...
import { ensureVillagePopulation, adjustPopulationMood } from "./villagePopulation.js"; // adjust path if needed
...
const PETITIONS = {
    ...
    lower_interest: {
        ...
        uiBlurb: "Argue that debt is strangling small folk and merchants. Ask the council to push for gentler loan terms.",
        uiEffectSummary: "Effect: Loan interest is reduced for a few in-game days. Savings and investments remain normal.",
        decreeTitle: "Decree: Loan Relief Act",
        decreeLabel: "Loan rates softened for a short time.",
        decreeDescription: "For the next few days, villagers with debts enjoy reduced interest. Savings and investments remain unchanged.",
        effect: {
    ...
    market_stimulus: {
        ...
        uiBlurb: "Propose incentives for savers and investors to spur commerce, accepting that inns and taverns will charge more.",
        uiEffectSummary: "Effect: Savings and investments earn more interest for a few days, but resting at the tavern becomes more expensive.",
        decreeTitle: "Decree: Market Stimulus Charter",
        decreeLabel: "Savers and investors are rewarded; inns raise their prices.",
        decreeDescription: "For a handful of days, deposits and investments grow faster, but the tavern quietly raises the cost of a night's rest.",
        effect: {
    ...
    festival_week: {
        ...
        uiBlurb: "Argue for a week of fairs, games and night markets to lift spirits and coffers alike.",
        uiEffectSummary: "Effect: Modest boosts to savings and investments; tavern rest becomes noticeably more expensive during the festivities.",
        decreeTitle: "Decree: Emberwood Festival Week",
        decreeLabel: "Stalls, music and lanterns fill the streets.",
        decreeDescription: "Banners and streamers bloom over Emberwood's lanes as the council grants a week of sanctioned revelry and trade.",
        effect: {
    ...
    austerity_drive: {
        ...
        uiBlurb: "Suggest a season of frugal living and tight ledgers to restore the village’s balance sheets.",
        uiEffectSummary: "Effect: Savings and investment returns shrink; loans ease slightly; rest at the tavern becomes cheaper.",
        decreeTitle: "Decree: Austerity Provisions",
        decreeLabel: "The council tightens belts across Emberwood.",
        decreeDescription: "By candlelight the councillors approve a lean budget, urging every household to mend old cloaks and patch their roofs.",
        effect: {
    ...
    fortification_levy: {
        ...
        uiBlurb: "Urge the council to raise coin for palisades, watchtowers, and extra guards on the walls.",
        uiEffectSummary: "Effect: Loan interest climbs; rest at the tavern grows more costly as levy barrels roll through the streets.",
        decreeTitle: "Decree: Emberwood Fortification Levy",
        decreeLabel: "Coin is hammered into stone and steel.",
        decreeDescription: "Engineers draw up new lines on the village map while grim guards collect the levy from merchants and tavernkeepers.",
        effect: {
            depositRateMultiplier: 1,
            investmentRateMultiplier: 1,
    ...
    grain_subsidy: {
        ...
        uiBlurb: "Ask the council to spend coin from the coffers to steady the price of bread and porridge.",
        uiEffectSummary: "Effect: Savings benefit slightly; loans ease a little; tavern rest becomes cheaper as food prices fall.",
        decreeTitle: "Decree: Grain Price Support",
        decreeLabel: "Bread lines shorten as prices settle.",
        decreeDescription: "Grain stores are quietly opened, and bakers receive sacks stamped with the royal seal to ease the hunger of the poor.",
        effect: {
            depositRateMultiplier: 1.1,
            investmentRateMultiplier: 1,
    ...
    merchant_charter: {
        ...
        uiBlurb: "Invite caravans and trading houses to treat Emberwood as their favored stop along the road.",
        uiEffectSummary: "Effect: Strong boosts to investment and savings; loans ease slightly; rest costs stay about the same.",
        decreeTitle: "Decree: Emberwood Merchant Charter",
        decreeLabel: "Contracts and seals inked in the counting-house.",
        decreeDescription: "Quills dance as merchants sign new accords, promising fuller caravans and louder coin in the village markets.",
        effect: {
    ...
    pilgrims_welcome: {
        ...
        uiBlurb: "Seek to make Emberwood a haven for pilgrims, with simple beds and warm soup at gentle prices.",
        uiEffectSummary: "Effect: Savings and investments weaken slightly; tavern rest becomes cheaper while the influx lasts.",
        decreeTitle: "Decree: Pilgrim’s Welcome",
        decreeLabel: "Lanterns and votive ribbons line the roads.",
        decreeDescription: "Shrines are swept clean and bunks prepared as Emberwood opens its gates to weary travelers seeking a holy road.",
        effect: {
    ...
    lenders_charter: {
        ...
        uiBlurb: "Urge the council to protect lenders and note-holders, arguing that strong credit keeps the realm steady.",
        uiEffectSummary: "Effect: Loan interest rises sharply; investments pay a bit more; savings suffer slightly.",
        decreeTitle: "Decree: Lenders’ Protection Charter",
        decreeLabel: "Ink dries on harsher loan terms.",
        decreeDescription: "Stern scribes revise loan ledgers under guard, while murmurs run through the poorer districts of Emberwood.",
        effect: {
    ...
    rainy_day_fund: {
        ...
        uiBlurb: "Encourage every household to salt away coin against lean years, with the council’s blessing.",
        uiEffectSummary: "Effect: Savings pay clearly better; investments are a bit dull; loan rates ease slightly.",
        decreeTitle: "Decree: Emberwood Reserve Fund",
        decreeLabel: "The council praises careful savers.",
        decreeDescription: "Bells ring softly as the council proclaims that prudent households will find their stored coin growing faster than before.",
        effect: {
    ...
    craftsman_stipends: {
        ...
        uiBlurb: "Propose a purse of royal coin to help smiths, weavers and carpenters take on apprentices and new tools.",
        uiEffectSummary: "Effect: Investment returns grow; tavern rest creeps up in price to cover stipends.",
        decreeTitle: "Decree: Craftsman’s Stipend Program",
        decreeLabel: "Workshop chimneys smoke late into the night.",
        decreeDescription: "Guild banners stir as young apprentices line up for stipends, bringing a hum of new work to Emberwood’s workshops.",
        effect: {
            depositRateMultiplier: 1,
    ...
    war_levy: {
        ...
        uiBlurb: "Call for a grim levy of coin and supplies to prepare for distant wars or looming threats.",
        uiEffectSummary: "Effect: Investments pay more; loans become punishing; tavern rest is much more expensive.",
        decreeTitle: "Decree: Emberwood War Levy",
        decreeLabel: "Carts of grain and steel roll out at dawn.",
        decreeDescription: "Recruiters march through the lanes as tax-collectors follow, their ledgers heavy with the weight of war.",
        effect: {
            depositRateMultiplier: 1,
            investmentRateMultiplier: 1.2,
    ...
    quiet_nights_act: {
        ...
        uiBlurb: "Suggest curfews on rowdy inns so the town can sleep more soundly — and drink more cheaply.",
        uiEffectSummary: "Effect: Tavern rest grows cheaper; savings and investments dip a little as nights quieten.",
        decreeTitle: "Decree: Quiet Nights Ordinance",
        decreeLabel: "The streets fall still after dark.",
        decreeDescription: "Town watch patrols tap their staves as shutters are drawn early; only low murmurs spill from Emberwood’s inns.",
        effect: {
            depositRateMultiplier: 0.95,
    ...
    debt_jubilee: {
        ...
        uiBlurb: "Plead for the slate to be wiped clean for the poorest debtors, at least for a time.",
        uiEffectSummary: "Effect: Loan interest plummets; savings and investments suffer; tavern prices stay the same.",
        decreeTitle: "Decree: Emberwood Jubilee Proclamation",
        decreeLabel: "Old ledgers close with a snap.",
        decreeDescription: "Lenders grind their teeth as debtors crowd the square, some weeping, some laughing at the news of forgiven notes.",
        effect: {
            depositRateMultiplier: 0.8,
    ...
    guild_investment_drive: {
        ...
        uiBlurb: "Encourage guilds and wealthy patrons to pour coin into risky ventures and caravans.",
        uiEffectSummary: "Effect: Investments pay strongly; rest costs rise; savings remain steady.",
        decreeTitle: "Decree: Guild Investment Drive",
        decreeLabel: "Coin flows into ledgers and caravans.",
        decreeDescription: "Guild masters raise their cups as new ventures are chartered, each promising silver rivers if fortune smiles.",
        effect: {
            depositRateMultiplier: 1,
    ...
    harvest_rebate: {
        ...
        uiBlurb: "Request that a good harvest’s surplus be turned back into the pockets of villagers and traders.",
        uiEffectSummary: "Effect: Savings and investments strengthen; loans ease; tavern rest becomes slightly cheaper.",
        decreeTitle: "Decree: Harvest Surplus Rebate",
        decreeLabel: "Granaries full, purses less tight.",
        decreeDescription: "With barns overflowing, the council decrees that not all bounty need be locked away in royal storehouses.",
        effect: {
            depositRateMultiplier: 1.2,
            investmentRateMultiplier: 1.2,
            loanRateMultiplier: 0.9,
    ...
    winter_relief: {
        ...
        uiBlurb: "Ask for firewood, blankets and coin to keep Emberwood’s poorest from freezing in the lean months.",
        uiEffectSummary: "Effect: Loans soften; tavern rest becomes cheap; savings and investments cool a bit.",
        decreeTitle: "Decree: Winter Hearth Relief",
        decreeLabel: "More smoke rises from chimneys each night.",
        decreeDescription: "Priests and volunteers haul bundles of wood and blankets through drifting snow, paid for by a grudging council purse.",
        effect: {
            depositRateMultiplier: 0.95,
            investmentRateMultiplier: 0.9,
...
function describeCouncillor(member) {
    ...
    if (status !== "active") {
        if (status === "deceased")
            ...
            statusSuffix = " – retired from council";
        else if (status === "recalled")
            statusSuffix = " – recalled by the realm council";
        else
            statusSuffix = " – former councillor";
    }
...
function ensureTownHallState(state, absoluteDay) {
    ...
    if (!state.government.townHall) {
        ...
        if (!Array.isArray(th.council))
            th.council = [];
        if (!("currentPetition" in th))
            th.currentPetition = null;
        if (!("lastResolvedPetition" in th))
            th.lastResolvedPetition = null;
        if (!Array.isArray(th.priorDecrees))
            th.priorDecrees = [];
        ...
        if (!("councilRecess" in th))
            th.councilRecess = false;
        if (!("recessReason" in th))
            th.recessReason = null;
        if (!("recessStartedOnDay" in th))
            th.recessStartedOnDay = null;
        if (!("recessEndsOnDay" in th))
            th.recessEndsOnDay = null;
    }
    ...
    if (Array.isArray(hall.council)) {
        hall.council.forEach(m => {
            if (!m)
                return;
            if (!m.status)
                m.status = "active"; // "active" | "deceased" | "retired" | "recalled"
            if (typeof m.seatedOnDay !== "number")
                m.seatedOnDay = today;
            if (!("leftOnDay" in m))
                m.leftOnDay = null;
            if (!("leftReason" in m))
...
function maybeUpdateVillageCouncilMembership(state, absoluteDay, addLog) {
    ...
    if (hall.councilRecess) {
        if (typeof hall.recessEndsOnDay === "number" &&
            ...
            const role = (sponsor && sponsor.role) ||
                "Councillor";
            ...
            logTownHall(state, addLog, `[Town Hall] Word arrives from Emberkeep: after a formal vote, the realm council confirms ${approx} as Emberwood's newest village councillor. The local council ends its recess and prepares to sit again.`, "info");
        }
        return;
    }
    // If not in recess, very rarely let a member die / resign / be removed.
    if (!Array.isArray(council) || !council.length)
        return;
    for (let i = 0; i < council.length; i++) {
        ...
        else if (reason === "removed_by_realm")
            member.status = "recalled";
        else
            member.status = "retired";
...
export function cleanupTownHallEffects(state, todayOverride = null) {
    ...
    if (!eff || typeof eff !== 'object')
        return { changed: false, active: false };
    const today = typeof todayOverride === "number"
        ? todayOverride
...
function buildActiveEffectSnapshot(state) {
    ...
    const econBits = [];
    if (Number.isFinite(pD) && Math.round(pD) !== 0)
        econBits.push(`Prosperity ${Math.round(pD) > 0 ? '+' : ''}${Math.round(pD)}/day`);
    if (Number.isFinite(tD) && Math.round(tD) !== 0)
        econBits.push(`Trade ${Math.round(tD) > 0 ? '+' : ''}${Math.round(tD)}/day`);
    if (Number.isFinite(sD) && Math.round(sD) !== 0)
        econBits.push(`Security ${Math.round(sD) > 0 ? '+' : ''}${Math.round(sD)}/day`);
    if (econBits.length)
        lines.push(`Ongoing nudge: ${econBits.join(' · ')}.`);
...
function applyApprovedPetition(state, petitionId, addLog) {
    ...
    const today = getCurrentDay(state);
    const hall = ensureTownHallState(state, today);
    if (!Array.isArray(hall.priorDecrees))
        hall.priorDecrees = [];
    const durationDays = PETITION_DURATION_DAYS;
    const { depositRateMultiplier = 1, investmentRateMultiplier = 1, loanRateMultiplier = 1, restCostMultiplier = 1, 
    // NEW: per-day economy nudges while the decree is active
    econProsperityDelta = 0, econTradeDelta = 0, econSecurityDelta = 0, 
    // Optional: per-day mood pressure
    moodDailyDelta = 0 } = def.effect || {};
    ...
    if (moodDelta !== 0 && moodLabel) {
        ...
        logTownHall(state, addLog, `[Town Hall] Word of "${def.decreeTitle}" rolls through ${approxPop}, leaving the mood a little more ${moodLabel}. By evening, scribes have nailed the fresh edict to the oak notice board, where knots of villagers argue over the new terms.`, moodDelta > 0 ? "good" : "system");
    }
    else {
        // If there was no mood change, still announce the decree being posted.
        logTownHall(state, addLog, `[Town Hall] Under flickering lamplight, the councillors have the scribes nail a fresh edict to the oak notice board: "${def.decreeTitle}". Villagers cluster under it, murmuring over the new terms.`, "info");
    }
}
// -----------------------------------------------------------------------------
// POPULATION VOTE
...
function resolvePopulationVote(state, hall, petition, addLog) {
    ...
    if (approved) {
        ...
        logTownHall(state, addLog, `[Town Hall] Word of the petition spreads through Emberwood. Gossip in the tavern and market stalls suggests most folk approve: perhaps ${supportPercent}% in favor — roughly ${approxFor} voices for it, against ${approxAgainst} mutters of doubt. The clerks quietly note the village’s leanings, preparing to set the measure before the council once they have slept on it.`, "info");
    }
    else {
        logTownHall(state, addLog, `[Town Hall] The petition becomes the talk of the lane. After a few days of argument, the mood is sour: only about ${supportPercent}% of villagers seem to favor it, with the rest complaining in doorways and over ale.`, "system");
    }
}
// -----------------------------------------------------------------------------
// VOTING LOGIC (DAILY TICK)
// -----------------------------------------------------------------------------
function getYesChanceForCouncillor(member, petitionId, state, popularSupportPercent, popularApproved) {
    const ideology = (member.ideology || "pragmatist").toLowerCase();
    const def = PETITIONS[petitionId];
    let chance = 0.55;
    if (def) {
...
export function handleTownHallDayTick(state, absoluteDay, hooks = {}) {
    ...
    if (petition && petition.status === "pending") {
        ...
        if (typeof petition.popularSupportPercent !== "number" &&
            ...
            if (!popApproved) {
                ...
                if (def) {
                    logTownHall(state, addLog, `[Town Hall] With most of Emberwood grumbling against "${def.uiTitle}", the parchment is quietly filed away. The councillors decline to call a formal vote on a measure the village clearly does not want.`, "system");
                }
            }
            else {
        ...
        if (petition &&
            ...
            council.forEach(member => {
                if (!member || member.status !== "active")
                    return;
                const chance = getYesChanceForCouncillor(member, petition.petitionId, state, popSupport, popApproved);
            ...
            if (approved) {
                ...
                logTownHall(state, addLog, `[Town Hall] After giving the village’s mood a night to settle, ${speakerDesc} raps the table and declares that the petition carries, ${yesVotes}–${noVotes}. The clerk finalizes "${decreeName}" as law while the murmurs from the square drift in through the shuttered windows.`, "good");
            }
            else {
                logTownHall(state, addLog, `[Town Hall] Though the village leaned in favor, ${speakerDesc} announces that the petition fails, ${yesVotes}–${noVotes}. A few villagers cheer, others go home shaking their heads.`, "system");
            }
        }
    }
...
function queuePlayerPetition(state, petitionId, addLog) {
    ...
    const hall = ensureTownHallState(state, today);
    if (hall.councilRecess) {
        logTownHall(state, addLog, "[Town Hall] The village council is currently in recess after a recent vacancy. Clerks apologise and explain that no new petitions can be formally docketed until a replacement councillor is seated.", "system");
        return;
    }
    if (hall.currentPetition && hall.currentPetition.status === "pending") {
        logTownHall(state, addLog, "[Town Hall] The council's docket is already full. Clerks politely inform you that no new petition can be heard until the current one is decided.", "system");
        return;
    }
    const voteDelay = randInt(MIN_VOTE_DELAY, MAX_VOTE_DELAY);
    hall.currentPetition = {
...
function buildPetitionStatusSummary(state) {
    ...
    const lines = [];
    if (hall.councilRecess) {
        let line = "The village council is presently in recess after a recent vacancy; no formal council votes will be held until a replacement councillor is appointed by the realm.";
        if (typeof hall.recessEndsOnDay === "number") {
    ...
    if (!current) {
        ...
        const source = current.submittedBy === "player"
        ...
        if (typeof current.popularSupportPercent === "number") {
            if (current.popularApproved) {
                ...
                lines.push(`Roughly ${current.popularSupportPercent}% of villagers seem to favor it.`);
                lines.push(when);
            }
            else {
                lines.push(`The villagers have mostly rejected this petition (${current.popularSupportPercent}% support); it will not advance to a council vote.`);
            }
        }
        else {
    ...
    if (last) {
        ...
        if (typeof last.popularSupportPercent === "number") {
            ...
            if (!last.popularApproved && last.yesVotes === 0 && last.noVotes === 0) {
                lines.push(`${title} was ${outcome} on day ${last.resolvedOnDay}. ${popPhrase}, so the councillors never took a formal vote.`);
            }
            else {
                lines.push(`${title} was ${outcome} (${last.yesVotes}–${last.noVotes}) on day ${last.resolvedOnDay}. ${popPhrase} before the councillors cast their votes.`);
            }
        }
        else {
            lines.push(`${title} was ${outcome} (${last.yesVotes}–${last.noVotes}) on day ${last.resolvedOnDay}.`);
        }
    }
    return lines;
}
 ...
 */
export function openTownHallModalImpl({ state, openModal, addLog, handleGovernmentDayTick, handleEconomyDayTick, updateHUD, saveGame }) {
    ...
    openModal("Town Hall & Council", body => {
        ...
        if (hall.councilRecess) {
            ...
            let reasonText = "A recent vacancy has left the council unable to sit; Emberwood's council is currently in recess.";
        ...
        function renderPriorDecrees() {
            ...
            prior.forEach(entry => {
                ...
                const li = document.createElement("li");
                const isActive = typeof start === "number" &&
                    typeof end === "number" &&
                    todayDay >= start &&
                    todayDay <= end;
